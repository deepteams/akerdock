...
- [ ] MFA TOTP (`mfa_factors` déjà migrée) — le step-up passkey couvre déjà le besoin de double contrôle ; le TOTP reste pour les authentificateurs sans WebAuthn
...
Les amendements n°13 à n°27, faits au fil des lots, sont documentés à l'endroit où ils ont été

...
SELECT dom.id, dom.uuid, dom.application_id, dom.service_component_id, dom.fqdn, dom.path, dom.target_port, dom.is_generated, dom.created_by, dom.created_at, dom.updated_at FROM domains dom

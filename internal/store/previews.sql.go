...
SELECT id, token_hash, preview_id, user_id, expires_at, created_at, application_id, resource_id FROM preview_access_tokens WHERE token_hash = $1 AND expires_at > now()
`

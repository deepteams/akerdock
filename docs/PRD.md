...
- **Événements** (activables individuellement **par canal**) : déploiement réussi/échoué, changement de statut de container (app arrêtée/unhealthy), backup réussi/échoué, scheduled task réussie/échouée, statut du Docker cleanup, seuil d'usage disque, **serveur injoignable / de nouveau joignable**, mises à jour disponibles, proxy obsolète.

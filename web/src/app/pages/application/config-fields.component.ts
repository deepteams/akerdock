...
@Component({
  ...
  template: `
    <fieldset class="group">
      ...
      <div class="akd-field">
        <label for="cf-tags">Tags (comma-separated, usable by the deploy webhook)</label>
        <input
          id="cf-tags"
          name="cfTags"
          class="akd-input"
    ...
    <fieldset class="group">
      ...
      @switch (sourceType()) {
        @case ('docker_image') {
          <div class="akd-field">
            <label for="cf-image">Docker image (registry included if not Docker Hub)</label>
            <input
              id="cf-image"
              name="cfImage"
          ...
          <div class="akd-field">
            <label for="cf-image-tag">Tag</label>
            <input
              id="cf-image-tag"
              name="cfImageTag"
              class="akd-input akd-mono"
          ...
          <div class="akd-field">
            <label for="cf-registry">Private registry credential</label>
            <select
              id="cf-registry"
              name="cfRegistry"
              class="akd-select"
        ...
        @case ('dockerfile') {
          <div class="akd-field">
            <label for="cf-dockerfile">Dockerfile</label>
            <textarea
              id="cf-dockerfile"
              name="cfDockerfile"
        ...
        @case ('git') {
          <div class="akd-field">
            <label for="cf-repo">Repository URL (HTTPS public, or SSH with a deploy key)</label>
            <input
              id="cf-repo"
              name="cfRepo"
              class="akd-input akd-mono"
          ...
          <div class="akd-field">
            <label for="cf-branch">Branch</label>
            <input
              id="cf-branch"
              name="cfBranch"
              class="akd-input akd-mono"
          ...
          <div class="akd-field">
            <label for="cf-key">Deploy key (private repositories)</label>
            <select
              id="cf-key"
              name="cfKey"
              class="akd-select"
          ...
          <div class="akd-field">
            <label for="cf-buildpack">Build pack</label>
            <select
              id="cf-buildpack"
              name="cfBuildPack"
              class="akd-select"
          ...
          <div class="akd-field">
            <label for="cf-basedir">Base directory (monorepos)</label>
            <input
              id="cf-basedir"
              name="cfBaseDir"
              class="akd-input akd-mono"
          ...
          @if (form().buildPack === 'dockerfile') {
            <div class="akd-field">
              <label for="cf-dockerfile-location">Dockerfile location (relative to base)</label>
              <input
          ...
          @if (form().buildPack === 'static') {
            <div class="akd-field">
              <label for="cf-publish">Publish directory</label>
              <input
                id="cf-publish"
                name="cfPublish"
                class="akd-input akd-mono"
          ...
          @if (form().buildPack === 'compose') {
            <div class="akd-field">
              <label for="cf-compose-location">Compose file location (relative to base)</label>
              <input
          ...
          <div class="akd-field">
            <label for="cf-watch">Auto-deploy watch paths (one pattern per line)</label>
            <textarea
              id="cf-watch"
              name="cfWatch"
              class="akd-textarea akd-mono"
      ...
      @if (sourceType() !== 'docker_image') {
        ...
        @if (form().useBuildServer) {
          <div class="akd-field">
            <label for="cf-push-registry">Push registry credential</label>
            <select
              id="cf-push-registry"
              name="cfPushRegistry"
              class="akd-select"
    ...
    <fieldset class="group">
      ...
      <div class="akd-field">
        <label for="cf-domains">Domains (one per line — fqdn, fqdn:port or fqdn/path)</label>
        <textarea
          id="cf-domains"
          name="cfDomains"
          class="akd-textarea akd-mono"
      ...
      <div class="akd-field">
        <label for="cf-ports">Exposed ports (comma-separated, e.g. 3000)</label>
        <input
          id="cf-ports"
          name="cfPorts"
          class="akd-input akd-mono"
    ...
    <fieldset class="group">
      ...
      @if (form().hcEnabled) {
        <div class="grid">
          <div class="akd-field">
            <label for="cf-hc-path">Path</label>
            <input
              id="cf-hc-path"
              name="cfHcPath"
              class="akd-input akd-mono"
          ...
          <div class="akd-field">
            <label for="cf-hc-port">Port (default: first exposed)</label>
            <input
              id="cf-hc-port"
              name="cfHcPort"
              class="akd-input akd-mono"
          ...
          <div class="akd-field">
            <label for="cf-hc-method">Method</label>
            <input
              id="cf-hc-method"
              name="cfHcMethod"
              class="akd-input akd-mono"
          ...
          <div class="akd-field">
            <label for="cf-hc-interval">Interval (s)</label>
            <input
              id="cf-hc-interval"
              name="cfHcInterval"
              class="akd-input akd-mono"
          ...
          <div class="akd-field">
            <label for="cf-hc-timeout">Timeout (s)</label>
            <input
              id="cf-hc-timeout"
              name="cfHcTimeout"
              class="akd-input akd-mono"
          ...
          <div class="akd-field">
            <label for="cf-hc-retries">Retries</label>
            <input
              id="cf-hc-retries"
              name="cfHcRetries"
              class="akd-input akd-mono"
          ...
          <div class="akd-field">
            <label for="cf-hc-start">Start period (s)</label>
            <input
              id="cf-hc-start"
              name="cfHcStart"
              class="akd-input akd-mono"
    ...
    <fieldset class="group">
      ...
      <div class="grid">
        <div class="akd-field">
          <label for="cf-mem">Memory limit (e.g. 512m, 2g — empty = unlimited)</label>
          <input
            id="cf-mem"
            name="cfMem"
            class="akd-input akd-mono"
        ...
        <div class="akd-field">
          <label for="cf-mem-res">Memory reservation</label>
          <input
            id="cf-mem-res"
            name="cfMemRes"
            class="akd-input akd-mono"
        ...
        <div class="akd-field">
          <label for="cf-mem-swap">Memory swap</label>
          <input
            id="cf-mem-swap"
            name="cfMemSwap"
            class="akd-input akd-mono"
        ...
        <div class="akd-field">
          <label for="cf-cpu">CPU limit (e.g. 0.5, 2)</label>
          <input
            id="cf-cpu"
            name="cfCpu"
            class="akd-input akd-mono"
        ...
        <div class="akd-field">
          <label for="cf-cpu-shares">CPU shares</label>
          <input
            id="cf-cpu-shares"
            name="cfCpuShares"
            class="akd-input akd-mono"
        ...
        <div class="akd-field">
          <label for="cf-cpu-set">CPU set (e.g. 0-2)</label>
          <input
            id="cf-cpu-set"
            name="cfCpuSet"
            class="akd-input akd-mono"

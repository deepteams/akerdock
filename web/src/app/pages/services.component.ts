...
@Component({
  ...
  template: `
    <div class="akd-page">
      ...
      <akd-modal [open]="creating()" title="New compose stack" (closed)="creating.set(false)">
        <form id="svc-create-form" class="modal-stack" (ngSubmit)="create()">
          <div class="akd-field">
